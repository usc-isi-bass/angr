...
def main():
    test_underconstrained_ddg()

def test_underconstrained_ddg():
    for arch in arches:
        run_underconstrained_ddg(arch)

def run_underconstrained_ddg(arch):
    test_file = os.path.join(test_location, arch, 'underconstrained_ddg')
